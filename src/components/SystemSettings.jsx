...
import { Settings, Bell, Globe, Save, Plus, Edit2, Trash2, Eye, EyeOff } from 'lucide-react'
import { getAnnouncements, createAnnouncement, updateAnnouncement, deleteAnnouncement } from '../../hooks/admin.js'
              ...
              announcements.map((ann) => (
                ...
                >
                  ...
                  <div style={{ display: 'flex', gap: 8 }}>
                    ...
                    >
                      {ann.active ? <EyeOff size={16} /> : <Eye size={16} />}
                    </button>
                    <button
