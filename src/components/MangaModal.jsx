  ...
  return createPortal(
    <div className="nt-overlay" onClick={onClose}>
      <div className="nt-modal" onClick={e => e.stopPropagation()}
        style={{ background: bg, border: `1px solid ${ROSE}30`,
        ...
        <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'stretch', minHeight: 380 }}>
          {/* Cover */}
          <div style={{ width: 185, minWidth: 185, flexShrink: 0, background: '#0f0508', overflow: 'hidden', position: 'relative' }}>
            {cover
            ...
            <div style={{ position: 'absolute', inset: 0,
              background: 'linear-gradient(to right, transparent 60%, #1a0a0f 100%)', pointerEvents: 'none' }} />
          </div>
