...
import { Vote, Calendar, Search, Edit2, Trash2 } from './icons.jsx'
          ...
          <tbody>
            {loading ? (
              ...
              votes.map((vote, index) => (
                <tr key={vote.id} style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
                  <td style={{ padding: '14px 20px', color: '#f1f5f9', fontSize: 14, fontWeight: 700 }}>
                    #{index + 1}
                  </td>
                  <td style={{ padding: '14px 20px', color: '#f1f5f9', fontSize: 14 }}>
                    {vote.novel_title}
                  </td>
                  <td
                    style={{
